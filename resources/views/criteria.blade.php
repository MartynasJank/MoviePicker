            ...
            <div>
                <div id="step-1" class="">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control bg-input movie-input border {{ ($errors->has('primary_release_date_lte')) ?  'border-danger' :  ''}}" id="primary_release_date_lte" name="primary_release_date_lte" placeholder="2024" value="{{ old('primary_release_date_lte') }}">
