...
<head>
    ...
    <meta property="og:image" content="@yield('og_image', URL::asset('/images/og-image.jpg'))">
    ...
    <meta name="twitter:image" content="@yield('og_image', URL::asset('/images/og-image.jpg'))">
