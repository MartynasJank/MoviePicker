...
<head>
    ...
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-204204564-1">
    </script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
...
<body class="{{ Cookie::get('theme') == 'dark' ? 'dark-theme' : 'light-theme' }}">
        ...
        <div class="container text-left d-flex custom-nav-container">
            ...
            <div id="mainListDiv" class="main_list flex-grow-1 ml-3">
                <ul class="navlinks">
                    ...
                    <a href="/roulettes" class="text-decoration-none"><li>Roulettes</li></a>
    ...
    <footer class="page-footer font-small my-3">
        <div class="footer-copyright text-center">© Martynas Jankauskas 2024</div>
    </footer>
</body>
</html>
